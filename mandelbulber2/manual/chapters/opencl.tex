...
\textbf{IMPORTANT}. Some updates have appeared to remove these changes to the registry, this maybe Win10 OS and/or Nvidia driver updates. If OpenCL begins to crash after an update, then check the registry.
