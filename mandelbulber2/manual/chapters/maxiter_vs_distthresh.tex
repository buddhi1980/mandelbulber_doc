...
\simpleImageWithCaptionHalfWidth{img/manual/media/stop_raymarching_at_disttrhersh_iter4}
...
\simpleImageWithCaptionHalfWidth{img/manual/media/stop_raymarching_at_maxiter_iter4}
